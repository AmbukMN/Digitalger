...
function _hits(text, list) {
  ...
  /**
   * ⚠️⚠️ АРАН ЯСЫГ ЗӨВХӨН ЛАТИН (галиг) БИЧВЭРТ ХЭРЭГЛЭНЭ.
   *
   * БОДИТ АЛДАА: «Хойд аав» (кино нэр) → аран яс «hd » болж,
   * «хэд вэ» → мөн «hd » болсон тул ТААРЧ, кино хайхын оронд
   * багцын үнэ буцаадаг байв (регресс, хэрэглэгч мэдээлсэн).
   *
   * Кирилл бичвэрийг хөрвүүлэх ШААРДЛАГАГҮЙ — түлхүүр үгс өөрөө
   * кирилл тул дээрх энгийн indexOf аль хэдийн барьсан. Аран яс
   * нь ЗӨВХӨН латинаар бичсэн галигт хэрэгтэй.
   */
  ...
  for (var j = 0; j < list.length; j++) {
    var ks = _skel(list[j]);
    /**
     * ⚠️ Аран яс 4-өөс богино бол ОГТ хэрэглэхгүй — «hd»/«un» гэх мэт
     * богино дараалал ямар ч үгэнд санамсаргүй таарна (нэр, кино нэр).
     * Урт түлхүүр үг (бүртгүүлэх=brtglh, төлбөр=tlbr) л найдвартай.
     */
    if (ks.length < 4) continue;
    /* ⚠️ ҮГИЙН ЗААГААР шалгана — дундуур таарахыг хориглоно */
    if (sk === ks || sk.indexOf(ks + ' ') === 0 || sk.indexOf(' ' + ks) !== -1) return true;
  }
  return false;
}
...
/* ⚠️ «bagts/bagc» — «багц»-ын аран яс 3 үсэгтэй (bgc) тул аран ясны
   шалгалтад орохгүй (богиныг санамсаргүй таарахаас сэргийлж хассан).
   Тиймээс түгээмэл ЛАТИН бичлэгийг ШУУД жагсаалтад нэмэв. */
const priceTriggers = ['багц','үнэ','төлбөр','хэд вэ','ханш','тариф','захиалга','subscribe','price',
  'bagts','bagc','bagtsuud','une hed','tulbur','tolbor'];
...
/* ⚠️ ХОЁР ӨӨР DM:
     linkType==='none' — постод киноны линк БАЙХГҮЙ → ерөнхий танилцуулга
     linkType==='movie' — постод тодорхой киноны линк БАЙНА → шууд тэр кино

   ⚠️ «бүртгүүлэлгүйгээр эхний ангиудыг шууд үзнэ» гэдэг нь БОДИТООР
      батлагдсан: isFreePreview анги нь нэвтрэлтгүй HTTP 200 буцаадаг
      (төлбөртэй анги 403). Энэ мөрийг өөрчлөх бол ЭХЛЭЭД шалга —
      худал амлалт нь хэрэглэгчийн итгэлийг алдагдуулна. */
var dmText = (linkType==='none')
  ? ('Сайн байна уу! 👋'+NL+NL
    +'Та BestTV-г ҮНЭГҮЙ туршиж үзээрэй —'+NL
    +'бүртгүүлэлгүйгээр эхний ангиудыг шууд үзнэ.'+NL+NL
