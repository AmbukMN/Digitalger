...
export interface TitleCard {
  ...
  /**
   * Харагдах ангийн тоо — картад «27 анги» гэж гарна.
   *
   * ⚠️ Хэрэглэгч цуврал хэдэн ангитайг ДАРАХААС ӨМНӨ мэдэх ёстой —
   *    3 ангитай юу, 60 ангитай юу гэдэг нь үзэх шийдвэрт нөлөөлнө.
   * ⚠️ Нэг ангит кинонд БАЙХГҮЙ (`undefined`) — «1 анги» гэж харуулах
   *    нь утгагүй. Нуусан анги ч тоологдохгүй.
   */
  episodeCount?: number;
}
