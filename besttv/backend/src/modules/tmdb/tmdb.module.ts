...
export class TmdbService {
  ...
  async fillCountryFromGenre(dryRun = false) {
    /**
     * Жанрын нэр → улс (админы баталсан зураглал).
     *
     * ⚠️ «Шилдэг кино» ЗОРИУД БАЙХГҮЙ — тэнд янз бүрийн улсын кино
     * холилдсон тул автоматаар таамаглавал БУРУУ утга орно. Тэднийг
     * TMDB (`/enrich`) эсвэл админ гараар бөглөнө.
     */
