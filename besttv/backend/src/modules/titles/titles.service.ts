  ...
  private async continueWatching(userId: string) {
    const rows = await this.prisma.watchProgress.findMany({
      where: {
        ...
        /**
         * ⚠️⚠️ 18+ КОНТЕНТ ЭНД ГАРАХГҮЙ — ЗӨВХӨН ЭНЭ ЭГНЭЭНД.
         *
         * БОДИТ ХЭРЭГЦЭЭ: «Үргэлжлүүлэн үзэх» нь нүүрний ДЭЭД эгнээ,
         * хэрэглэгч нэвтрэнгүүт АВТОМАТААР харагдана — гэр бүлийн
         * орчинд, хажууд хүнтэй үед ч. Хэрэглэгч өөрөө сонгож үзсэн
         * ч дараа нь ил гарахыг хүсэхгүй.
         *
         * ⚠️ Бусад газар (нүүр, каталог, хайлт, баннер, ижил төстэй)
         *    18+ ХЭВЭЭР гарна — тэр нь админы 2026-08-15-ны шийдвэр.
         *    Энэ бол тэр шийдвэрийг буцаасан хэрэг БИШ, зөвхөн НЭГ
         *    эгнээний онцгой дүрэм.
         *
         * ⚠️ `none` — киноны жанрын АЛЬ Ч нь 18+ биш байх ёстой.
