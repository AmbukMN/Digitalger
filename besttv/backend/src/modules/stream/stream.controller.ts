...
export class StreamController {
  ...
  /**
   * ⚠️⚠️ ЭВДЭРСЭН ПОСТЕРЫГ АВТОМАТААР СЭРГЭЭНЭ.
   *
   * БОДИТ АЛДАА: хөрвүүлэлтийн үед poster нь R2 руу байршиж
   * чадаагүй тохиолдол гардаг (сүлжээ тасрах, түр алдаа). DB-д зам
   * үлдсэн ч файл БАЙХГҮЙ тул эвдэрсэн зураг харагдана
   * (Spartacus E01, Аймаар хайр E01 — бодитоор олдсон).
   *
   * `posters/backfill` нь 177 ангийг ДАРААЛАН шалгадаг тул нэг
   * эвдэрсэн ангид хүрэхэд удаан. Энэ нь ЯГ ТЭР ангийг л засна —
   * frontend нь зураг унасныг мэдэмгц дуудна.
   *
   * ⚠️ Постер БАЙГАА бол юу ч хийхгүй (`already`) — хэрэглэгч
