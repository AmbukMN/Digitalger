...
export class StreamService {
  ...
  private async logDenied(
    ...
    try {
      ...
      /**
       * ⚠️⚠️ ЗОЧНЫ ТАТГАЛЗАЛ БҮРТГЭГДЭХГҮЙ — АЛДАА БИШ.
       *
       * БОДИТ АСУУДАЛ: 24 цагт 583 мөр «Эрхгүй хандалт (зочин)»
       * бүртгэгдсэн — нийт логийн 84%. Энэ нь нэвтрээгүй хүн
       * төлбөртэй видео дарсан = систем ЗӨВ ажилласан явдал.
       *
       * Үр дагавар нь ноцтой: жинхэнэ алдаа (ХУГАЦАА ДУУССАН ТОКЕН,
       * ЭРХТЭЙ атлаа татгалзсан) 583 мөрийн дунд БУЛАГДАЖ, админ
       * `/errors` хуудсыг нээхэд юу ч олохгүй.
       *
       ...
       * ⚠️⚠️ ЗОЧНЫ ТАТГАЛЗАЛ бүртгэгдэхгүй — алдаа БИШ.
       *
       * Нэвтрээгүй хүн төлбөртэй видео дарсан = систем ЗӨВ
       * ажилласан. Өдөрт ~500 мөр үүсч жинхэнэ алдааг булдаг.
       *
       * ⚠️ ГЭХДЭЭ НЭВТЭРСЭН хэрэглэгчийн 403-ыг ЗААВАЛ бүртгэнэ —
       * «багц авсан атлаа кино эхлэхгүй» гомдлыг оношлох ЦОРЫН
       * ГАНЦ арга (бодит тохиолдол: 6 хэрэглэгч).
       *
       * ⚠️ `rangeProbe`-ыг ч бүртгэнэ: Хишигсайханы 33 удаагийн 403
       * нь probe БИШ байсан (хажууд нь 200 огт алга) — тэр шүүлт
       * хэт өргөн байж жинхэнэ алдааг нуусан.
       */
      if (!userId) return;
