 ...
 *
 * ⚠️ 2 → 3 болов (2026-08-30): гар утасны апп гарахад апп нь ГУРАВ дахь
 * төхөөрөмж болно (компьютер + утасны браузер + апп). 2 хэвээр байвал
 * хэрэглэгч апп суулгамагц компьютерээсээ ГЭНЭТ гарч, «эвдэрсэн» гэж
 * гомдоллоно.
 *
 * ⚠️ Хэрэглэгчид харагдах тоог ЭНДЭЭС авна (`/auth/sessions` → `max`) —
 * frontend-д hardcode ХИЙХГҮЙ. Зөвхөн үнийн хуудасны зар нь тусдаа текст.
 */
