 ...
 */
/**
 * Админ SEO тохируулж болох замууд.
 *
 * ⚠️ ЗӨВХӨН frontend-д `buildPageMetadata`-аар БОДИТООР уншигддаг замыг
 * энд бичнэ. Уншигддаггүй зам нэмбэл админ тохируулаад «яагаад
 * өөрчлөгдөхгүй байна» гэж эргэлзэнэ.
 *
 * ⚠️ `/series` ХАСАГДСАН — тэр зам нь `/movies` руу 308 redirect хийдэг
 *    stub тул тохируулсан meta ХЭЗЭЭ Ч рендерлэгдэхгүй.
 */
