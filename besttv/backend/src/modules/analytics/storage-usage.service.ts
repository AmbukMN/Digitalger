 ...
 *
 * Cron 2 цаг тутам сэргээдэг тул TTL 2.5 цаг — ингэснээр кэш ХЭЗЭЭ Ч
 * хоосрохгүй (хоосорвол дараагийн админ «тооцоолж байна» хардаг).
...
export class StorageUsageService {
   ...
   *
   * ⚠️⚠️ 2 ЦАГ тутам (өмнө нь 8 минут байсан). ЯАГААД УРТАСГАВ:
   ...
   *   · 2 цаг тутам = сард ~310 мянга (14 дахин бага). Зайн хэмжээ
   *     2 цагт мэдэгдэхүйц өөрчлөгддөггүй тул мэдээлэл хуучрахгүй.
