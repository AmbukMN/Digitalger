...
const DEFAULT_BANK: BankSettings = {
  ...
  /**
   * ⚠️⚠️ ЗААВАЛ TRUE. Баримтгүй мэдэгдэл нь админд шалгах ЮМГҮЙ ажил
   * үүсгэдэг (хэрэглэгч «шилжүүлсэн» гэж дарахад л болчихно).
   *
   * ⚠️ Өмнө нь `false` байсан бөгөөд БАЗАД ХАДГАЛАГДСАН тохиргоонд энэ
   * талбар ОГТ БАЙГААГҮЙ тул серверийн шалгалт (claim доторх
   * `cfg.requireReceipt && ...`) ХЭЗЭЭ Ч ажиллаагүй — зөвхөн browser-ийн
   * UI хамгаалж байсан нь хангалтгүй (API-г шууд дуудвал тойрно).
   * Тиймээс default-ыг true болгов: талбар байхгүй хуучин тохиргоо ч
   * одооноос баримт шаардана.
   */
  requireReceipt: true,
};
