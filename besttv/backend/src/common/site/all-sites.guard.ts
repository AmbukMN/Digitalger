...
export class AllSitesGuard implements CanActivate {
  ...
  canActivate(context: ExecutionContext): boolean {
    ...
    /**
     * ⚠️⚠️ НЭВТРЭХ ЗАМД ХОРИГЛОХГҮЙ.
     *
     * БОДИТ АЛДАА (хэрэглэгч мэдээлсэн): админ сүүлд «Бүх сайт»
     * сонгоод гарсан бол тэр сонголт `localStorage`-д үлдэж, дараа
     * нь нэвтрэхэд `X-Site: all` явна → энэ guard 403 шидэж, админ
     * ОГТ орж чадахгүй болно (нууц үг зөв ч).
     *
