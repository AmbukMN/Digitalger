...
const nextConfig: NextConfig = {
  ...
  images: {
    ...
    /**
     * ⚠️⚠️ ПОСТЕРЫН БОДИТ ХЭМЖЭЭНД ТААРУУЛСАН.
     *
     * БОДИТ АСУУДАЛ: нүүрийн HTML 1 MB болсны 292 KB (41%) нь `<img>`
     * таг байв — 121 зураг × 2,418 байт. Шалтгаан нь Next-ийн анхдагч
     * `imageSizes` (16·32·48·64·96·128·256·384) бүх хувилбарыг srcset-д
     * бичдэг. Гэтэл постер нь `sizes="180px"` / `"150px"` — ТОГТМОЛ
     * жижиг тул 16w/32w/48w огт хэрэггүй.
     *
     * ⚠️ Зургийн ЧАНАР ӨӨРЧЛӨГДӨХГҮЙ — хөтөч 180px-д аль хэдийн 256w
     * авдаг байсан. Зөвхөн хэрэглэгддэггүй мөрүүд srcset-ээс хасагдана.
     *
     * ⚠️ `deviceSizes` ХӨНДӨӨГҮЙ — hero/banner нь өргөн `sizes`-тэй тул
     * том хэмжээнүүд хэвээр хэрэгтэй.
     */
