...
export default function GlobalError({
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center bg-background px-4 text-center">
      <h1 className="text-3xl font-black text-white">Алдаа гарлаа</h1>
      ...
      <div className="mt-6 flex gap-3">
        ...
        <Link href="/" className="rounded-md bg-white/10 px-5 py-2.5 font-medium text-white hover:bg-white/20">
          Нүүр рүү буцах
        </Link>
      </div>
    </main>
