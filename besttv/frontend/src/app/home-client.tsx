...
export function HomeClient() {
  ...
  return (
    <main className="min-h-screen bg-background pb-16">
      {/*
        ⚠️⚠️ НҮҮР ХУУДСАНД `<h1>` ОГТ БАЙХГҮЙ байв.
        Хамгийн өндөр эрх мэдэлтэй хуудас (sitemap priority 1.0) үндсэн
        гарчиггүй байсан тул «монгол кино онлайн» гэх түлхүүр үгэнд
        өрсөлдөх боломж алдагдаж байв.
