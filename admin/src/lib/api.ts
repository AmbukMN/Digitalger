...
export const adminApi = {
  ...
  products: {
    ...
    lessons: {
      ...
      create: (productId: string, body: { title: string; description?: string; content?: string; videoUrl?: string; videoKey?: string; rawVideoKey?: string; videoStreamId?: string; streamStatus?: string; posterKey?: string; durationSec?: number; isFreePreview?: boolean; sortOrder?: number; moduleId?: string }) =>
        adminFetch<AdminLesson>(`/admin/products/${productId}/lessons`, { method: 'POST', body: JSON.stringify(body) }),
      update: (productId: string, lessonId: string, body: Partial<{ title: string; description: string; content: string; videoUrl: string; videoKey: string; rawVideoKey: string; videoStreamId: string; streamStatus: string; posterKey: string | null; durationSec: number; isFreePreview: boolean; sortOrder: number; moduleId: string | null }>) =>
