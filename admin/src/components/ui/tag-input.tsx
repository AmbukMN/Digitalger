  ...
  return (
    ...
    >
      {value.map((tag, i) => (
        <span
          key={`${tag}-${i}`}
          className="inline-flex items-center gap-1 rounded-md border border-transparent bg-secondary/70 px-2 py-0.5 text-xs font-medium text-secondary-foreground dark:bg-secondary/40"
        >
          {tag}
          <button
            type="button"
