...
const CHAT_WEBHOOK_URL =
  process.env.NEXT_PUBLIC_CHAT_WEBHOOK_URL ?? 'https://bot.digitalger.mn/webhook/bestfilm-chat';
...
const WELCOME: ChatMessage = {
  id: 'welcome',
  role: 'bot',
  /* ⚠️ TEMPLATE literal (` `) — энгийн хашилтад `${}` ажиллахгүй,
     хэрэглэгчид «Би ${BRAND.name}-ийн» гэж ШУУД харагдана */
  text: `Сайн байна уу! 👋 Би ${BRAND.name}-ийн AI туслах. Кино хайх, багц сонгох, төлбөрийн талаар асуугаарай.`,
};
    ...
    try {
      const res = await fetch(CHAT_WEBHOOK_URL, {
        ...
        body: JSON.stringify({
          ...
          /**
           * ⚠️⚠️ САЙТ — n8n нь `/chat/ingest` руу ДАМЖУУЛНА.
           * Үүнгүйгээр BestFilm-ийн чат BestTV-ийн админ панелд гарна.
           */
          site: BRAND.key,
        }),
      });
          ...
          >
            ...
            <div className="flex items-center gap-2.5 bg-primary px-4 py-3 text-primary-foreground">
              ...
              <div className="min-w-0 flex-1">
                <p className="text-sm font-bold leading-tight">
                  {handedOff ? `${BRAND.name} Багийн гишүүн` : `${BRAND.name} AI`}
                </p>
            ...
            <div className="border-t border-foreground/10 bg-background p-3">
              ...
              <p className="mt-1.5 text-center text-[10px] text-foreground/30">
                BestFilm AI — кино сонгоход тусална
              </p>
            </div>
          </motion.div>
        )}
