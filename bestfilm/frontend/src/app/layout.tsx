...
export async function generateMetadata(): Promise<Metadata> {
  ...
  const homeTitle = home?.title || seo?.metaTitle || BRAND.metaTitle;
  const homeDesc =
  ...
  return {
    title: { default: homeTitle, template: `%s | ${seo?.siteName ?? BRAND.name}` },
    ...
    openGraph: {
      ...
      description: homeDesc,
      url: SITE_URL,
      siteName: seo?.siteName ?? BRAND.name,
      locale: 'mn_MN',
      type: 'website',
