...
import { SERVER_API_URL, serverFetch } from '@/lib/server-api';
...
export async function POST() {
   ...
   */
  /* ⚠️ `serverFetch` — OAuth нь САЙТ бүрд тусдаа хэрэглэгч үүсгэнэ.
     Толгойгүй бол BestFilm-ээр нэвтэрсэн хүн BestTV-д бүртгэгдэнэ. */
  const res = await serverFetch(`/api/auth/oauth`, {
    method: 'POST',
    headers: {
